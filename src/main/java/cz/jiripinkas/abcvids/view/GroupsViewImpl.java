...
import cz.jiripinkas.abcvids.presenter.GroupsPresenter;
import cz.jiripinkas.abcvids.ui.MyVaadinUI;

@SuppressWarnings("serial")
@UIComponent
public class GroupsViewImpl extends AbstractMVPView implements GroupsView {
	...
	public void enter(ViewChangeEvent event) {
		final GroupsPresenter presenter = (GroupsPresenter) getPresenter();

		// load data
		BeanContainer<Integer, Group> container = new BeanContainer<Integer, Group>(
				Group.class);
		container.setBeanIdProperty("id");
		container.addAll(presenter.findAll());
